...
const ModalActiveJobs = ({modal, handleOk, handleCancel, data}) => {
  ...
  <div className="mt-5 border-t border-gray-200 pt-5"> */}
    <dl>
      ...
      <div className="mt-8 sm:grid sm:mt-5 sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <dd className="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
          {dayjs(data.setupDate).format("MMMM D, h:mm A")}
        </dd>
      </div>
      <div className="mt-8 sm:grid sm:mt-5 sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
        <dt className="text-sm leading-5 font-medium text-gray-500">
        ...
        <dd className="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
          {dayjs(data.pulldownDate).format("MMMM D, h:mm A")}
        </dd>
      </div>
      <div className="mt-8 sm:grid sm:mt-5 sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
        <dt className="text-sm leading-5 font-medium text-gray-500">
      ...
      <div className="mt-8 sm:grid sm:mt-5 sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <dd className="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
        "Not Provided Yet. Need to grab from GraphQL"
        </dd>
      </div>
      <div className="mt-8 sm:grid sm:mt-5 sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
        <dt className="text-sm leading-5 font-medium text-gray-500">
        ...
        <dd className="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
        "Not Provied Yet. Need to grab from GraphQL"
        </dd>
      </div>
    </dl>
  </div>
